...
Audita la implementación contra el `plan.md`, el `execution.md` y el
`handoff.md` de esa iniciativa.
...
- el artefacto debe incluir obligatoriamente `## Hallazgos`, `## Justificación del veredicto`, `## Escalado de remediacion` y `## Condición para F7`
- además de escribir `post_audit.md`, replica el artefacto completo al final de tu respuesta en un bloque ```md``` para recuperación del orquestador si la escritura falla
